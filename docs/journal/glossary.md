...
- **Тренд использования** — presentation-ряд за последние 7 дней, построенный из локальной истории сэмплов; это не дополнительный лимит и не live-метрика провайдера. Встречается: `SparklineContent`, `UsageTrendView`, `showUsageTrends`.
